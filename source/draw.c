...
void DrawStringF(int x, int y, const char *format, ...)
{
    ...
    DrawString(BOT_SCREEN0, str, x, y, RGB(0, 0, 0), RGB(255, 255, 255));
    DrawString(BOT_SCREEN1, str, x, y, RGB(0, 0, 0), RGB(255, 255, 255));
}
...
void Debug(const char *format, ...)
{
    ...
    DrawString(BOT_SCREEN0, str, 10, current_y, RGB(0, 0, 0), RGB(255, 255, 255));
    DrawString(BOT_SCREEN1, str, 10, current_y, RGB(0, 0, 0), RGB(255, 255, 255));

    current_y += 10;
    if (current_y > SCREEN_HEIGHT) current_y = 0;
}

void ClearBot()
{
	ClearScreen(BOT_SCREEN0, RGB(255, 255, 255));
